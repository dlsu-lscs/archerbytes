        ...
        <Card className="rounded-2xl border shadow-sm hover:shadow-md transition-shadow overflow-hidden gap-0">
            ...
            <div className="flex justify-between items-center px-5 pb-4">
                ...
                <div className="flex items-center gap-1 text-muted-foreground">
                    <button className="p-1 rounded hover:bg-accent hover:text-foreground transition-colors" aria-label="Not interested">
                    ...
                    <BookmarkButton
                        ...
                        size="medium"
                    />
                    <button className="p-1 rounded hover:bg-accent hover:text-foreground transition-colors" aria-label="More options">
